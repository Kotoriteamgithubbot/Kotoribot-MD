  const fs = require('fs')
  let _inventoryOrang = JSON.parse(fs.readFileSync('./database/game/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./database/game/inventory.json', JSON.stringify(_inventoryOrang))
   }
